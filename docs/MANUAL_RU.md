...
1.  **Login Mode (Режим входа):**
    ...
    *   **Окно ноды (справа сверху):** Занимает 75% высоты. Предназначено для ввода пароля и авторизации.
    *   **Логи (справа снизу):** Компактная область (25% высоты) для контроля статуса.
