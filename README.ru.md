...
>
> *Примечание для пользователей ArcaneOS:* Благодаря новому режиму **Monitor Mode**, вы можете полностью скрыть веб-интерфейс ноды после авторизации, сфокусировавшись на мониторинге событий через полноэкранный лог.
...
1.  **Main Process (`monitor-main.js`)**
    ...
    *   **Применяет политики:** Запускает основной цикл автоматизации для остановки приложений, соответствующих черному списку.
...
-   `GET /apps/appremove?appname={appName}`
    *   **Цель:** Отправляет команду на остановку/удаление определенного контейнера приложения, если он нарушает политику.
