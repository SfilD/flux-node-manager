...
![Скриншот Flux Auto-Deleter v0.9.9](assets/screenshot.png)

## Скачивание и Установка

Последняя версия: **v0.9.9**

**[Скачать из GitHub Releases](https://github.com/SfilD/flux-auto-deleter/releases/latest)**

Вы можете выбрать:
*   **Portable (.zip):** Установка не требуется. Просто распакуйте и запустите `FluxAutoDeleter_Portable_0.9.9.exe`.
